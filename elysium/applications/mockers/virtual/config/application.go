...
type Application struct {
	...
	SecondaryRange  utilities.SecondaryRange  `kong:"embed"`
	TertiaryRange   utilities.TertiaryRange   `kong:"embed"`
	QuaternaryRange utilities.QuaternaryRange `kong:"embed"`
